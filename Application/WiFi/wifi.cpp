...
namespace WIFI
{
    ...
    void Wifi::SetCredentials(const char *ssid, const char *password)
    {
        ...
        // {
        //     strncpy(reinterpret_cast<char *>(_wifi_cfg.sta.ssid), ssid, sizeof(_wifi_cfg.sta.ssid) - 1);
        //     _wifi_cfg.sta.ssid[sizeof(_wifi_cfg.sta.ssid) - 1] = '\0'; // Đảm bảo chuỗi null-terminated
        // }
        // else
        // {
        //     strncpy(reinterpret_cast<char *>(_wifi_cfg.sta.ssid), "default_ssid", sizeof(_wifi_cfg.sta.ssid) - 1);
        //     _wifi_cfg.sta.ssid[sizeof(_wifi_cfg.sta.ssid) - 1] = '\0';
        // }

        // if (password && strlen(password) > 0)
        // {
        //     strncpy(reinterpret_cast<char *>(_wifi_cfg.sta.password), password, sizeof(_wifi_cfg.sta.password) - 1);
        //     _wifi_cfg.sta.password[sizeof(_wifi_cfg.sta.password) - 1] = '\0'; // Đảm bảo chuỗi null-terminated
        // }
        // else
        // {
        //     strncpy(reinterpret_cast<char *>(_wifi_cfg.sta.password), "default_password", sizeof(_wifi_cfg.sta.password) - 1);
        //     _wifi_cfg.sta.password[sizeof(_wifi_cfg.sta.password) - 1] = '\0';
        // }
    }
